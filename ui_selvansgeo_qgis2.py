...
class Ui_SelvansGeo(object):
    def setupUi(self, SelvansGeo):
        ...
        self.horizontalLayoutWidget = QtGui.QWidget(SelvansGeo)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 10, 521, 581))
        self.horizontalLayoutWidget.setObjectName(_fromUtf8("horizontalLayoutWidget"))
        self.horizontalLayout = QtGui.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.tabPanel = QtGui.QTabWidget(self.horizontalLayoutWidget)
    ...
    def retranslateUi(self, SelvansGeo):
        ...
        self.lblVersion.setText(_translate("SelvansGeo", "<html><head/><body><p><span style=\" font-weight:600;\">SelvansGeo 3.0.0</span> du 24.07.20017 pour QGIS <span style=\" font-weight:600;\">2.99 + &amp; 2.18 LTR</span></p></body></html>", None))
