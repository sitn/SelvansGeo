...
class Ui_SelvansGeo(object):
    def setupUi(self, SelvansGeo):
        ...
        self.tabPanel = QtWidgets.QTabWidget(SelvansGeo)
        ...
        self.frameIcon_3 = QtWidgets.QFrame(self.tabEdit)
        ...
        self.frameIcon_3.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.frameIcon_3.setFrameShadow(QtWidgets.QFrame.Plain)
        self.frameIcon_3.setLineWidth(0)
        self.frameIcon_3.setObjectName(_fromUtf8("frameIcon_3"))
        self.grpViewNodes = QtWidgets.QGroupBox(self.tabEdit)
        self.grpViewNodes.setGeometry(QtCore.QRect(10, 9, 481, 81))
        self.grpViewNodes.setObjectName(_fromUtf8("grpViewNodes"))
        self.chkSelectByCanvasExtent = QtWidgets.QCheckBox(self.grpViewNodes)
